    ...
    return (
          ...
          <ActionPanel>
            ...
            <Action
              ...
              onAction={async () => {
                ...
                const { ticket, downloadDir } = values as {
                  ticket: string;
                  downloadDir: string[];
                };
      ...
      >
        ...
        <Form.Description
          ...
          text="The file will download directly to the selected directory. Large files may take some time to complete."
        />
      </Form>
    );
  }
